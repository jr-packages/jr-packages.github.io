...
Each course uses a large number of R packages that should (if possible) be installed before the course.
...
Depending on which codeclan course you are attending, you will need a different course package. Please scroll to the correct course and follow the instructions. If you're attending more than one course, follow all sets of instructions! Don't hesitate to get in contact if something isn't working
