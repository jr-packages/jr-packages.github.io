...
For this course you must all have the [Anaconda
distribution](https://www.anaconda.com/download/) of Python and on top
of that you must download the course modules we have built. Instructions
...
5.  Choose the integrated development enviroment (IDE) you’d like to
    code Python in and install it. I will be using Spyder for the course
    as it is much better for teaching purposes but it is totally up to
    you what you use. Another popular choice is jupyter notebooks.
